...
BuildRequires:	 cmake(Qt6Core) cmake(Qt6Core5Compat) cmake(Qt6Concurrent) cmake(Qt6Gui) cmake(Qt6LinguistTools) cmake(Qt6Network) cmake(Qt6PrintSupport) cmake(Qt6Qml) cmake(Qt6Widgets) cmake(Qt6Xml) cmake(Qt6WebEngineWidgets)
BuildSystem:	cmake
